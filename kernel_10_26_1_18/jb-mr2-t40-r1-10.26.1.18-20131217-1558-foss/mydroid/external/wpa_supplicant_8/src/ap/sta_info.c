...
#ifdef SOFTAP_POWERSAVING
	sprintf(buf, "am broadcast --user 0 -a com.android.server.WifiManager.action.AP_STA_CHANGE --ei num_sta %d", hapd->num_sta);
	wpa_printf(MSG_INFO, "AP: STA FREE num_sta = %d", hapd->num_sta);
	system(buf);
#endif
...
#ifdef SOFTAP_POWERSAVING
	sprintf(buf, "am broadcast --user 0 -a com.android.server.WifiManager.action.AP_STA_CHANGE --ei num_sta %d", hapd->num_sta);
	wpa_printf(MSG_INFO, "AP: STA JOIN num_sta = %d", hapd->num_sta);
	system(buf);
#endif
