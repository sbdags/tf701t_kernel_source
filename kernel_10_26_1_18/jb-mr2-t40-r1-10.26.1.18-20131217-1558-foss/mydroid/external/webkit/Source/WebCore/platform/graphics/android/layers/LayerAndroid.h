...
public:
    ...
    typedef enum { StandardLayer, ScrollableLayer,
                   ...
                   ForegroundBaseLayer,
                   EGLImageLayer,
                   TextureBackedCanvasLayer, BaseLayer } SubclassType;
    ...
    const char* subclassName() const
    {
        switch (subclassType()) {
            ...
            case LayerAndroid::EGLImageLayer:
                return "EGLImageLayer";
            case LayerAndroid::TextureBackedCanvasLayer:
                return "TextureBackedCanvasLayer";
    ...
    bool drawTreeSurfacesGL(bool layerTilesDisabled);
    ...
    LayerContent* content() const { return m_content; }
    ...
    virtual void updatePosition(SkRect viewport,
...
// rendering asset management
    ...
    virtual bool handleNeedsDisplay() { return false; }
...
private:
    ...
    void setVisible(bool value) { m_visible = value; } // Only for backface culling
    ...
    bool drawSurfaceAndChildrenGL(bool layerTilesDisabled);
