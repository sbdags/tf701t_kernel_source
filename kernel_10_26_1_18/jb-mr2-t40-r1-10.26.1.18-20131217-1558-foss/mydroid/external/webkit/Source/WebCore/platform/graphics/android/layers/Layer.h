...
// children
    ...
    void draw(SkCanvas*, android::DrawExtra*, SkScalar opacity, bool showVisualIndicator);

    void setHasOverflowChildren(bool value) { m_hasOverflowChildren = value; }

    virtual bool contentIsScrollable() const { return false; }

    enum { MergedLayers = 1, UnmergedLayers = 2, FlattenedLayers = 3,
           PaintVisualIndicator = 4 };
    typedef unsigned PaintStyle;
