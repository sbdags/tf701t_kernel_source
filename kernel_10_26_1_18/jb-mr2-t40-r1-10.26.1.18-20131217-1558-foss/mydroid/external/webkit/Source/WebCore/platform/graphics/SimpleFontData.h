...
#if ENABLE(SVG_FONTS)
    static PassRefPtr<SimpleFontData> create(PassOwnPtr<SVGFontData> fontData, int size, bool syntheticBold, bool syntheticItalic)
    {
        return adoptRef(new SimpleFontData(fontData, size, syntheticBold, syntheticItalic));
    }
#endif
...
private:
    ...
    SimpleFontData(PassOwnPtr<SVGFontData> , int fontSize, bool syntheticBold, bool syntheticItalic);
