...
namespace WebCore {
    ...
    public:
        ...
        MySelectionController* mySelection();
    ...
    private:
        ...
        mutable MySelectionController m_mySelectionController;
    ...
    inline MySelectionController* Frame::mySelection()
    {
        return &m_mySelectionController;
    }
