...
public:
    ...
    */
    ...
    void markTouchSensitiveRegionsDirty();
    const Vector<IntRect>& collectTouchSensitiveRegions();

    void didAddTouchEventListener(Node*);
    void didRemoveTouchEventListener(Node*);
#endif
...
#if ENABLE(TOUCH_EVENTS)
    void didRemoveAllTouchEventListeners();
#endif
...
#endif
#if ENABLE(TOUCH_EVENTS)
    typedef HashCountedSet<RefPtr<Node> > TouchSensitiveNodeMap;
    TouchSensitiveNodeMap m_touchSensitiveNodes;

    Vector<IntRect> m_touchSensitiveRegions;
    bool m_touchSensitiveRegionsDirty;
#endif
