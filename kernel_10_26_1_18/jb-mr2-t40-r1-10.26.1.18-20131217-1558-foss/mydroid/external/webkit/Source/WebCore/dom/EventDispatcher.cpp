...
doneDispatching:
    ...
    if (!event->defaultPrevented() && !event->defaultHandled()) {
        ...
        // FIXME: On Android, the touch handling in SliderThumbElement is implemented in default
        // event handler. The code sets prevent default flag because, to signal the UI side to
        // start sending the events to the engine side.
