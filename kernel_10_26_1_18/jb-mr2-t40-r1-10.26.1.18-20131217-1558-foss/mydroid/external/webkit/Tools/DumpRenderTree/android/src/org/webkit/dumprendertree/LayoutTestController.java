    ...
    class LayoutTestControllerJSObject {
        ...
        public void overridePreference(String key, boolean value) {
            if (WEBKIT_OFFLINE_WEB_APPLICATION_CACHE_ENABLED.equals(key)) {
                mWebView.setAppCacheEnabled(value);
            }
            else if (WEBKIT_USES_PAGE_CACHE_PREFERENCE_KEY.equals(key)) {
                mWebView.setMaxPageCacheCapacity();
            }
        }

        @JavascriptInterface
        public void setAppCacheMaximumSize(long size) {
            mWebView.setAppCacheMaxSize(size);
        }
        ...
        public void setDatabaseQuota(long quota) {
            mWebView.setDatabaseQuota(quota);
        }
        ...
        public void setXSSAuditorEnabled(boolean flag) {
            mWebView.setXSSAuditorEnabled(flag);
        }
        ...
        @JavascriptInterface
        public void setUseInvertedRendering(boolean useInvertedRendering, float contrast) {
            mWebView.postSetInvertedRendering(useInvertedRendering, contrast);
        }
    };
